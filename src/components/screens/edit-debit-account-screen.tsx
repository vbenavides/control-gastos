...
export function EditDebitAccountScreen() {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-[36rem] px-4 pb-28 md:max-w-[40rem] md:px-6 lg:max-w-[680px] lg:px-8">
      ...
      <div className="sticky bottom-0 z-20 border-t border-white/8 bg-[#111a23] px-6 pb-5 pt-5 shadow-[0_-10px_28px_rgba(0,0,0,0.28)]">
